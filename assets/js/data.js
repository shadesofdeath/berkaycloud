...
window.SITE = {
  ...
  i18n: {
    en: {
      ...
      "hero.k1": "Berkay Ay",
      "hero.k2": "a.k.a. ShadesOfDeath",
      "hero.k3": "Türkiye · UTC+3",
      ...
      "hero.f1.k": "Stack",
      "hero.f1.v": "C++20 · Win32",
      "hero.f2.k": "Also",
      "hero.f2.v": "C# · WPF · PowerShell",
      "hero.f3.k": "On GitHub since",
      "hero.f3.v": "2020",
      "hero.f4.k": "Licences",
      "hero.f4.v": "MIT · GPL · all open",
      "hero.f5.k": "Scroll",

      "about.index": "About",
      "about.meta1": "Berkay Ay",
      "about.meta2": "Est. 2020",
      ...
      "rules.index": "Rules",
      "rules.meta1": "Applies to",
      "rules.meta2": "Every release",
    ...
    tr: {
      ...
      "hero.k1": "Berkay Ay",
      "hero.k2": "nam-ı diğer ShadesOfDeath",
      "hero.k3": "Türkiye · UTC+3",
      ...
      "hero.cta.github": "GitHub",
      "hero.f1.k": "Teknolojiler",
      "hero.f1.v": "C++20 · Win32",
      "hero.f2.k": "Ayrıca",
      "hero.f2.v": "C# · WPF · PowerShell",
      "hero.f3.k": "GitHub'da",
      "hero.f3.v": "2020'den beri",
      "hero.f4.k": "Lisanslar",
      "hero.f4.v": "MIT · GPL · hepsi açık",
      "hero.f5.k": "Kaydır",

      "about.index": "Hakkında",
      "about.meta1": "Berkay Ay",
      "about.meta2": "2020'den beri",
